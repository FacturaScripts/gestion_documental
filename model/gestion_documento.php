...
//        $albaranprov = new albaran_proveedor();
    ...
    {
        $all = array_merge($this->all_facturas_clientes(), $this->all_albaranes_clientes(), $this->all_facturas_proveedores(), $this->all_albaranes_proveedores());
        return $all;
    }
    
    public function all_facturas_clientes()
    {
        $model = new factura_cliente();
        return $this->all_by_model($model);
    }

    public function all_facturas_proveedores()
    {
        $model = new factura_proveedor();
        return $this->all_by_model($model);
    }

    public function all_albaranes_clientes()
    {
        $model = new albaran_cliente();
        return $this->all_by_model($model);
    }

    public function all_albaranes_proveedores()
    {
     ...
     */
    protected function all_by_model($model)
    {
        $fdesde = $this->filtros['fdesde'];
        $fhasta = $this->filtros['fhasta'];
