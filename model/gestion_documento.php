...
class gestion_documento extends fs_model
{
    ...
    public function get_documents($sql, $sql_res, $sql_pages, $offset, $adjunto, $tabla, $id)
    {
        ...
        $resultados = $this->db->select_limit("SELECT f.*, d.*, f.fecha as fecha, d.nombre as doc_nombre, d.fecha as doc_fecha, d.hora as doc_hora FROM " . $sql_res . $wh . " ORDER BY f.fecha DESC, f.codigo DESC ", FS_ITEM_LIMIT, $offset);
